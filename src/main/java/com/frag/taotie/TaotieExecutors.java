...
public class TaotieExecutors<T> {
     ...
     * 下面是单队列构造器
     */
    public static <T> TaotieActuator singleQueueProcessor(ObjIntConsumer<List<T>> benchCommit) {
        return singleQueueProcessor(SINGLE_QUEUE_BENCH_COMMIT_NUM_DEFAULT, 1, benchCommit);
    }

    public static <T> TaotieActuator singleQueueProcessor(int benchCommitNum, int commitThreadNum, ObjIntConsumer<List<T>> benchCommit) {
        return singleQueueProcessor(benchCommitNum, commitThreadNum, SINGLE_QUEUE_CAPACITY_FACTOR_DEFAULT, benchCommit);
    }

    public static <T> TaotieActuator singleQueueProcessor(int benchCommitNum, int commitThreadNum, float queueCapacityFactor, ObjIntConsumer<List<T>> benchCommit) {
    ...
    public static <T> TaotieActuator singleQueueProcessor(int benchCommitNum, int commitThreadNum, float queueCapacityFactor, int offerTimeout, int pollTimeout, ObjIntConsumer<List<T>> benchCommit) {
     ...
     * 下面是多队列构造器
     */
    public static <T> TaotieActuator multipleQueueProcessor(int queuePower, int benchCommitNum, int pollThreadPower, int commitThreadNum, ObjIntConsumer<List<T>> benchCommit, Function<T, Number> getHashKey) {
    ...
    public static <T> TaotieActuator multipleQueueProcessor(int queuePower, int benchCommitNum, int pollThreadPower, int commitThreadNum, float queueCapacityFactor, ObjIntConsumer<List<T>> benchCommit, Function<T, Number> getHashKey) {
    ...
    public static <T> TaotieActuator multipleQueueProcessor(int queuePower, int benchCommitNum, int pollThreadPower, int commitThreadNum, float queueCapacityFactor, int offerTimeout, int pollTimeout, ObjIntConsumer<List<T>> benchCommit, Function<T, Number> getHashKey) {
